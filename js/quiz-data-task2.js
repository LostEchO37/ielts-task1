    ...
    questions: [
      {
        ...
        feedbackCorrect: "比较型 = 两边要拿来比。",
        feedbackWrong: "关键词是两个议论词，意味着 A vs B。"
      },
      {
        ...
        feedbackCorrect: "笔记要求一边倒，不能和稀泥。",
        feedbackWrong: "此类题型应选边站，无法论证 a = b。"
      },
      {
      ...
      },
      {
        ...
        feedbackCorrect: "6 分钟审题列提纲，留足写作时间。",
        feedbackWrong: "6 min 审题 + 34 min 写作。"
      },
      {
